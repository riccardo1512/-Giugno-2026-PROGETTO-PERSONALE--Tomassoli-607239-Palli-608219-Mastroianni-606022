...
-- Credentials
-- NOTA: Se Spring Security utilizza BCryptPasswordEncoder, potresti dover sostituire 'elena' e 'admin'
-- con i rispettivi hash (es: $2a$10$...), altrimenti il login fallirà.
INSERT INTO credentials (id, username, password, role, user_id) VALUES (1, 'elena', 'elena', 'DEFAULT', 1);
INSERT INTO credentials (id, username, password, role, user_id) VALUES (2, 'admin', 'admin', 'ADMIN', 2);
